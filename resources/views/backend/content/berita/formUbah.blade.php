            ...
            <div class="card-body">
                <form action="{{route('berita.prosesUbah')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <p></p>
                        <img id="tampilFoto" onerror="this.onerror=null; this.src='https://www.shutterstock.com/id/image-illustration/no-picture-available-placeholder-thumbnail-icon-2179364083'" src="{{route('storage', $berita->gambar_berita)}}" alt="" width="15%"
                    </div>
                    ...
                    <input type="hidden" name="id_berita" value="{{$berita->isi_berita}}">
